...
export function persistContextOverview(
  ...
  lines.push('# CodeAtlas — Codebase Semantic Context');
  lines.push('');
  lines.push('> Generated by CodeAtlas. Use this file as the entry point for LLM tools.');
  ...
  lines.push('');
  lines.push('All context files are in `.codeatlas/context/`. Each source file has a corresponding');
